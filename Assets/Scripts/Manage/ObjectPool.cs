...
public class ObjectPool : Singleton<ObjectPool> {
	...
	List<GameObject> pooledEnemyObj = new List<GameObject>();
	List<GameObject> pooledLaserObj = new List<GameObject>();
	List<GameObject> pooledHeartObj = new List<GameObject>();
	#endregion
	...
	public GameObject PopFromPool(EnemyType enemyType, Vector3 position, Transform poolParent = null, Transform spawnParent = null) {
		switch (enemyType) {
			...
			case EnemyType.Laser:
				...
				GameObject laserObj = pooledEnemyObj[0];
				pooledEnemyObj.RemoveAt(0);
			...
			case EnemyType.Heart:
				...
				GameObject heartObj = pooledEnemyObj[0];
				pooledEnemyObj.RemoveAt(0);
